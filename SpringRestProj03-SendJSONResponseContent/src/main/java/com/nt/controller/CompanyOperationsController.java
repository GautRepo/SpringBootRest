...
public class CompanyOperationsController {
	  ...
	  @GetMapping("/show") 
	  public ResponseEntity<Company> showCompanyDetailss(){
	...
	/*
	 * @GetMapping("/show") public Company showCompanyDetails(){ // create and
	 * return model class obj Company company=new Company("HCL", "hyd",
	 * 100,500000000.0, "IT"); return company; }
	 */

	@GetMapping("/showall")
	public ResponseEntity<Employee> showCompanyDetails() {
		Company company = new Company("HCL", "hyd", 100, 500000000.0, "IT");
		Employee emp = new Employee(1001, "Raja", new String[] { "red", "green", "blue" }, // java 9 features
				...
				false, LocalDateTime.of(1990, 10, 12, 13, 30), company);
